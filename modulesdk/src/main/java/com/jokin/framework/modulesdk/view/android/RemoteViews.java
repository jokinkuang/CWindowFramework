...
public class RemoteViews implements Parcelable, Filter {
     ...
     */
    protected static final int MAX_NESTED_VIEWS = 10;
     ...
     * @hide
     */
    protected ApplicationInfo mApplication;
     ...
     * RemoteViews.
     */
    protected RemoteViews mLandscape = null;
    protected RemoteViews mPortrait = null;
    ...
    public static class OnClickHandler {
        ...
        public boolean onClickHandler(View view, PendingIntent pendingIntent,
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                throw new InvalidParameterException("have not implementation!!");
            }
        }
        ...
        public boolean onClickHandler(View view, PendingIntent pendingIntent,
            ...
            try {
                ...
                if (mEnterAnimationId != 0) {
                    ...
                    // API
                    // https://developer.android.com/reference/android/app/ActivityOptions.html#makeBasic()
    ...
    private class SetOnClickFillInIntent extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, final OnClickHandler handler) {
            ...
            if (target == root) {
                // Jokin: target.setTagInternal(com.android.internal.R.id.fillInIntent, fillInIntent);
                target.setTag(innerRId("fillInIntent"), fillInIntent);
                ...
                OnClickListener listener = new OnClickListener() {
                    public void onClick(View v) {
                        ...
                        while (parent != null && !(parent instanceof AdapterView<?>)
                                && !((parent instanceof AppWidgetHostView) && cls != null &&
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        if (view instanceof ViewGroup) {
                            ...
                            for (int i = 0; i < childCount; i++) {
                                Object tag = vg.getChildAt(i).getTag(innerRId("fillInIntent"));
    ...
    private class SetRemoteViewsAdapterList extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, OnClickHandler handler) {
            ...
            Class cls = null;
            try {
                cls = Class.forName("android.widget.RemoteViewsListAdapter");
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }
            if (cls == null) {
                throw new NullPointerException("Has a bug!!!");
            }
            ...
            if (target instanceof AbsListView) {
                ...
                //     v.setAdapter(new RemoteViewsListAdapter(v.getContext(), list, viewTypeCount));
                // }
                if (cls.isInstance(a) && viewTypeCount <= a.getViewTypeCount()) {
                    try {
                        cls.getMethod("setViewsList", ArrayList.class).invoke(list);
                    ...
                    try {
                        v.setAdapter((ListAdapter) cls.getConstructor(Context.class, ArrayList.class, int.class).newInstance(v.getContext(), list, viewTypeCount));
    ...
    private Method getMethod(View view, String methodName, Class<?> paramType) {
        ...
        synchronized (sMethodsLock) {
            ...
            if (method == null) {
                ...
                if (cls == null) {
                    throw new NullPointerException("It's a bug!");
                }
    ...
    private final class ReflectionAction extends Action {
        ...
        ReflectionAction(Parcel in) {
            ...
            switch (this.type) {
                ...
                case ICON:
                    if (in.readInt() != 0) {
                        // Jokin: Icon was added in API 23
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
        ...
        public void apply(View root, ViewGroup rootParent, OnClickHandler handler) {
            ...
            if (drawablesLoaded) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    id1 = i1 == null ? null : i1.loadDrawable(ctx);
                    id2 = i2 == null ? null : i2.loadDrawable(ctx);
                    id3 = i3 == null ? null : i3.loadDrawable(ctx);
                    id4 = i4 == null ? null : i4.loadDrawable(ctx);
                }
                if (isRelative) {
                    target.setCompoundDrawablesRelativeWithIntrinsicBounds(id1, id2, id3, id4);
                } else {
    ...
    private class SetRemoteInputsAction extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, OnClickHandler handler) {
            ...
            target.setTag(innerRId("remote_input_tag"), remoteInputs);
        }
    ...
    public RemoteViews(String packageName, int layoutId) {
        ...
        this(getApplicationInfo(packageName, getUserId(Process.myUid())), layoutId);
    }
    ...
    private View inflateView(Context context, RemoteViews rv, ViewGroup parent) {
        ...
        v.setTag(innerRId("widget_frame"), rv.getLayoutId());
        return v;
    }
    ...
    private static void loadTransitionOverride(Context context,
        ...
        //             RemoteViews.innerRStylableId("Window"));
    ...
    public void reapply(Context context, View v, OnClickHandler handler) {
        ...
        if (hasLandscapeAndPortraitLayouts()) {
            if ((Integer) v.getTag(innerRId("widget_frame")) != rvToApply.getLayoutId()) {
    ...
    private static ApplicationInfo getApplicationInfo(String packageName, int userId) {
        ...
        if (getUserId(applicationInfo.uid) != userId
